<template>
  <div class="grid grid-cols-2 p-2" style="grid-template-columns: 15% auto;" v-if="cpu !== null">
    <div class="p-2 flex items-center shadow hover:bg-gray-100 transition duration-300 transform hover:-translate-y-1 hover:scale-110 select-none">
    ...
    <div class="grid grid-cols-4 gap-2 p-2">
      <div class="col-span-4 p-2 shadow-xs hover:bg-gray-100 transition duration-300">
        <div class="text-md font-normal select-none">Processador</div>
        <div class="text-lg font-medium">{{cpu.brand}}</div>
      </div>
      <div class="p-2 shadow-xs hover:bg-gray-100 transition duration-300">
        <div class="text-md font-normal select-none">Clock</div>
        <div class="text-lg font-medium select-none">{{cpu.speedmax}} Ghz</div>
      </div>
      <div class="p-2 shadow-xs hover:bg-gray-100 transition duration-300">
        <div class="text-md font-normal select-none">Uso Atual</div>
        <div class="text-lg font-medium select-none">{{(currentSpeed).toFixed()}}%</div>
      </div>
      <div class="p-2 shadow-xs hover:bg-gray-100 transition duration-300">
        <div class="text-md font-normal select-none">Núcleos</div>
        <div class="text-lg font-medium select-none">{{cpu.cores}}</div>
      </div>
      <div class="p-2 shadow-xs hover:bg-gray-100 transition duration-300">
        <div class="text-md font-normal select-none">Núcleos Logicos</div>
        <div class="text-lg font-medium select-none">{{cpu.physicalCores}}</div>
      </div>
    </div>
